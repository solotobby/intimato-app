                    ...
                    <div class="nk-block-head nk-page-head">
                        <div class="nk-block-head-between">
                            <div class="nk-block-head-content">
                                <h2 class="display-6">Unlimited Intimate Stories</h2>
                                <p>Go beyond the limit. Unlock deeper, unforgettable stories that connect, heal, and excite.</p>
                            </div>
                        </div>
                    </div><!-- .nk-page-head -->
                    <div class="nk-block">
                                                ...
                                                <div class="w-sm-70 w-md-50 w-xl-100 text-center text-xl-start mx-auto">
                                                    ...
                                                    <div class="pricing-price-wrap">
                                                        <div class="pricing-price">
                                                            <h3 class="h2 mb-2">£{{$plan->discount_amount}} <span class="caption-text text-muted"> formally <span class="text-decoration-line-through">£{{$plan->amount}} </span></span></h3>
                                                    ...
                                                    <ul class="pricing-features">
                                                        ...
                                                        @endif
                                                        {{-- <li><em class="icon text-primary ni ni-check-circle"></em><span>1000 words/mo. generation</span></li>
                                                        <li><em class="icon text-primary ni ni-check-circle"></em><span>Total 5000 words generation</span></li>
                                                        <li><em class="icon text-primary ni ni-check-circle"></em><span>Access to 10 templates</span></li>
                                                        <li><em class="icon text-primary ni ni-check-circle"></em><span>Upto 5 projects can be created</span></li>
                                                        <li><em class="icon text-primary ni ni-check-circle"></em><span>Only 7 days of generation history</span></li> --}}
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
